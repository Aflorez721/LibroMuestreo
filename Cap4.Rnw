...
print(T4.1, caption.placement="bottom")
@
...
print(T4.2, caption.placement="bottom")
@
...
T4.3 <- xtable(Estimaciones, caption ="\\emph{Muestreo $pi$PT: estimación de los totales de las características de interés}", label ="T4.3")
print(T4.3, caption.placement="bottom")
@
...
\item Demuestre o refute la siguiente afirmación: <<En muestreo Poisson, cuando las probabilidades de inclusión son tales que $\pi_k=n y_k/t_y$ la varianza del estimador de Horvitz-Thompson es nula>>.
...
$${x}=\{1005, 1072,  884,  907, 1068,  625,  705,  909, 692,  891, 1046, 1052\}$$
    \begin{itemize}
      \item Calcule la correlación entre $y^2/x$ y $x$.
